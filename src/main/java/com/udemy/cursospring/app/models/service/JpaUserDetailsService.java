...
import com.udemy.cursospring.app.models.dao.IUsuarioDao;
import com.udemy.cursospring.app.models.entity.Role;
...
public class JpaUserDetailsService implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if(authorities.isEmpty()) {
			...
			throw new UsernameNotFoundException("El usuario: '"+ username + "' no tiene roles asigandos");
		}
